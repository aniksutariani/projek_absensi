        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h2 class="mt-4">Absensi Pulang</h2>
                ...
                <div class="row justify-content-space-between">
                                    <div class="row justify-content-space-between">
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-body ">
                                                    <form method="POST" action="absensi_pulang.php">
                                            ...
                                            <div class="card-body ">
                                                        ...
                                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                ...
                                                                echo "<form method='POST' action='absensi_pulang.php'>";
                                                                ...
                                                                echo "<input type='submit' name='submit_pulang' value='Simpan Absensi Pulang'>";
                                                                echo "</form>";
                                                            } else {
                                                                echo "Pegawai tidak ditemukan.";
                                                            }

                                                            $id_pegawai = $_POST['id_pegawai']; // Ambil ID Pegawai dari form atau sumber lainnya
                                                        $query_cek_absensi = "SELECT * FROM presensi WHERE id_pegawai = '$id_pegawai' AND jam_pulang IS NULL";
                                                        $result_cek_absensi = $conn->query($query_cek_absensi);

                                                        if ($result_cek_absensi->num_rows > 0) {
                                                            // Jika sudah ada absensi masuk yang belum diabsen pulang
                                                            // Izinkan untuk melakukan absensi pulang
                                                            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_pulang'])) {
                                                                // Lakukan proses untuk melakukan absensi pulang
                                                                date_default_timezone_set('Asia/Kuala_Lumpur');  
                                                                $tgl_pulang = date('Y-m-d');
                                                                $jam_pulang = date('H:i:s');
                                                                
                                                                $query_absensi_pulang = "UPDATE presensi SET jam_pulang = '$jam_pulang' WHERE id_pegawai = '$id_pegawai' AND jam_pulang IS NULL";
                                                                
                                                                if ($conn->query($query_absensi_pulang) === TRUE) {
                                                                    echo "<p>Absensi pulang berhasil disimpan pada tanggal $tgl_pulang jam $jam_pulang.</p>";
                                                                } else {
                                                                    echo "Error: " . $query_absensi_pulang . "<br>" . $conn->error;
                                                                }
                                                            }
                                                        } else {
                                                            // Jika belum ada absensi masuk yang belum diabsen pulang
                                                            echo "<p>Anda belum melakukan absensi masuk atau sudah melakukan absensi pulang.</p>";
                                                        }
                                                        $conn->close();
                                                    }
                                                        ?>
                                            ...
                                            <div class="card-header">
                                                ...
                                                Data Absensi Pulang Pegawai
                                            </div>
                                                    <div class="card-body">
                                                        <table class="table responsif">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID Pegawai</th>
                                                                    <th>Nama Pegawai</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                // Query untuk mendapatkan data absensi pulang
                                                                $query_absensi = "SELECT pegawai.id_pegawai, pegawai.nama_pegawai, presensi.tgl, presensi.jam_pulang 
                                                                FROM pegawai 
                                                                ...
                                                                if ($result_absensi->num_rows > 0) {
                                                                    ...
                                                                    echo "<tr><td colspan='4'>Tidak ada data absensi pulang.</td></tr>";
                                                                }
                                                                $koneksi->close();
                                                                ?>
                                                            </tbody>
